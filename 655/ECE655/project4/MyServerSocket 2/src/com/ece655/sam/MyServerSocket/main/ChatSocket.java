		...
		try {
			...
			while ((line = br.readLine()) != null) {
				...
				case "!@#D_GRP!@#":
					...
					break;
				case "!@#L_USR!@#":
					String group = line.substring(11).trim();
					String usersInTheGroup = GroupManager.getGroupManager().getAllUserFromAGroup(group);
					ChatManager.getChatManager().publishToItselfOnly(this, "*****Users in this group are :'"+usersInTheGroup+"*****\n");
					System.out.println("User in this group are: "+usersInTheGroup);
				}
